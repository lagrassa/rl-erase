...
class PouringWorld():
    ...
    def parameterized_pour(self, offset=-0.05, desired_height = 0.7, step_size=0.175, dt = 0.11, force=1500):
        pourer_pos, pourer_orn = p.getBasePositionAndOrientation(self.base_world.cupID)
        ...
        self.move_cup((pourer_pos[0], pourer_pos[1], desired_height), start_euler, duration=3.5, force=1500)
