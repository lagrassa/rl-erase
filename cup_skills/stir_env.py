...
class StirEnv():
    ...
    def __init__(self, visualize=True, real_init=True):
        ...
        self.world = world
        self.world_state = self.world.base_world.world_state() 
    ...
    def step(self, action):
        ...
        if self.replay_counter == 0: #never end episode during experience replay
            ...
            episode_over = self.world.base_world.cup_knocked_over() or  not self.world.stirrer_close()
